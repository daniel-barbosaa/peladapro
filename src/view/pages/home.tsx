...
export function Home() {
  ...
  const { pelada, resetPelada, startMatch } = usePeladaStore();
            ...
            <div className="rounded-2xl border border-emerald-700/30 bg-linear-to-br from-emerald-900/30 to-emerald-950/30 p-6">
              ...
              <div className="space-y-3">
                ...
                <button
                  onClick={() => {
                    if (
                      confirm("Tem certeza que deseja encerrar esta pelada?")
                    ) {
                      resetPelada();
                    }
                  }}
